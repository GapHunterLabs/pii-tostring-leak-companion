package dev.gaphunter.piitostringleakcompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.piitostringleakcompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.piitostringleakcompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "PII via toString() Leak Companion"
